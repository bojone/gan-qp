...
g_loss = K.mean(xz_real_score - xz_fake_score) + 4 * K.mean(K.square(z_fake - z_fake_)) + 6 * K.mean(K.square(x_real - x_real_))
...
g_train_model.metrics_tensors.append(4 * K.mean(K.square(z_fake - z_fake_)) + 6 * K.mean(K.square(x_real - x_real_)))
